...
CREATE TABLE `OSSFile` (
  ...
  `fileSize` int NOT NULL COMMENT 'oss文件大小',
  `fileUrl` varchar(255) NOT NULL UNIQUE COMMENT 'oss文件访问路径',
...
CREATE TABLE `CompanyDetail` (
  ...
  `companyId` int(10) UNIQUE COMMENT '公司用户id',
  `fullName` varchar(20) NOT NULL UNIQUE COMMENT '公司全称',
  `shortName` varchar(20) NOT NULL UNIQUE COMMENT '公司简称',
