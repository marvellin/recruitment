		...
		<div id="body" style="min-height: 835px;">
			...
			<div id="container">
				<div class="clearfix">
		                            ...
		                            <ul class="reset my_collections">
		                            	<li v-for="(item,index) in position2companylist">
		                               	...
		                               	<!--<li data-id="133340">
		                             		<a title="携程旅行网" target="_blank" href="h/c/6636.html">
		                             			<img alt="携程旅行网" src="../../../static/images/ff808081441c19bf01441f9a47190b3a.png">
		                             		</a>
		                             		<div class="co_item">
		                             			<h2 title="酒店业务助理">
		                            	...
		                            	<li data-id="148886">
		                             		<a title="蘑菇街" target="_blank" href="h/c/108.html">
		                             			<img alt="蘑菇街" src="../../../static/images/ff80808142a8df050142b1674c596676.jpg">
		                             		</a>
		                             		<div class="co_item">
		                             			<h2 title="PHP">
		                            	...
		                            	<li data-id="148519">
		                             		<a title="搜狗" target="_blank" href="h/c/1537.html">
		                             			<img alt="搜狗" src="../../../static/images/ff80808142e0968f0142e0d41f1205f2.jpg">
		                             		</a>
		                             		<div class="co_item">
		                             			<h2 title="商家运营">
		            ...
		            <div class="content_r">
		            	<div class="mycenterR" style="margin-top: 0;" id="myInfo">
		            		<h2>我的信息</h2>
		            		<!--<a href="collections.html">我收藏的职位</a>-->
		            		<router-link to="/collection">我收藏的职位</router-link>
		            		<br>
		            		<!--<a target="_blank" href="subscribe.html">我订阅的职位</a>-->
		            		<router-link to="">我订阅的职位</router-link>
		            	</div><!--end #myInfo-->
		            	<!--<div class="greybg qrcode mt20">
		                	<img width="242" height="242" alt="拉勾微信公众号二维码" src="../../../static/images/qr_delivery.png">
...
<script>
	...
	export default{
		...
		created(){
			this.$axios.get('/static/data/position2company.json').then(res => {
				this.position2companylist = res.data.position2companylist
