  			...
  			<div class="clearfix">
            	...
            	<div class="content_r">
					...
					<div class="mycenterR" id="myResume">
	            		<h2>我的附件简历 
	            			<a title="上传附件简历" href="#uploadFile" class="inline cboxElement" @click.prevent="uploadboxshow=true">上传简历</a>
	            		</h2>
...
<!-------------------------------------弹窗lightbox ----------------------------------------->
			<div style="display:none;">
				<!-- 上传简历 -->
				<div :class="[uploadboxshow?'':'popup']" :style="{'display':uploadboxshow?'none':''}" id="uploadFile" v-show="uploadboxshow">
